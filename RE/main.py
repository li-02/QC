...
def main():
    ...
    parser.add_argument("--file-path", "-d", type=str, default="./data/2024_shisanling_flux_raw_data.csv", help="数据文件路径")
    ...
    parser.add_argument("--longitude", "-lon", type=float, default=116.28824, help="经度")
    parser.add_argument("--latitude", "-lat", type=float, default=40.265635, help="纬度")
    ...
    try:
        ...
        logger.info(f"参数信息: file-path={args.file_path}, data-type={args.data_type}, "
