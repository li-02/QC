...
from processors.storage_correction import do_add_strg, not_add_strg, filter_flux_by_qc_flags, copy_flux_columns_without_qc_filter, handle_campbell_special_case
from processors.thresholds import threshold_limit
from processors.gap_filling import gap_fill_par
...
class DataQc:
    ...
    def _remove_unnecessary_columns(self):
        """删除不需要的列"""
        columns_to_remove = [
            'short_up_avg', 'rh_12m_avg', 'rh_10m_avg', 'ta_12m_avg'
        ]
